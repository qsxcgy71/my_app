    ...
    try {
      ...
      for (final doc in snapshot.docs) {
        ...
        try {
          ...
          if (activity.date.year == _focusedDay.year && 
              activity.date.month == _focusedDay.month) {
  ...
  Future<void> _saveActivity(
    ...
    try {
      final activity = Activity(
        ...
        time: startTime,
        endTime: endTime,
        createdAt: editActivity?.createdAt ?? DateTime.now(),
      );
      ...
      if (editActivity == null) {
        ...
        newActivityWithId = activity.copyWith(id: docRef.id);
        ...
        final activityData = activity.toMap();
        activityData['userId'] = userId;
        await _firestore.collection('activities').doc(editActivity.id).update(activityData);
        
        // Update local state immediately
        final updatedActivity = activity.copyWith(id: editActivity.id);
